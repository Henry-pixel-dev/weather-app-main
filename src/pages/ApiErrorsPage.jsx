...
const ErrorsPage = () => {
  return (
    <div className='min-h-screen flex flex-col justify center space-y-6'>
      ...
      <p className='max-w-md text-netural-200 text-base text-center'>
        We couldn't connect to the server (Api error). Please try again in a few moment.
      </p>

      <button className='text-neutral-200 flex flexl-row items-center justify-around space-x-2 p-3 rounded-lg'>
        <img src={RetryIcon} alt="retryIcon" className='w-10 h-10' />
        <span>
          r#Retry
        </span>
      </button>
